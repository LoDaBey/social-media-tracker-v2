...
import { setEmployeeCode } from "@/actions/admin";
import type { AdminEmployeeCodeModalProps } from "@/types/admin";
...
export function AdminEmployeeCodeModal({
  open,
  employeeId,
  fullName,
  employeeCode,
  onClose,
}: AdminEmployeeCodeModalProps) {
  return (
    <AnimatePresence>
      {open ? (
        <AdminEmployeeCodeDialog
...
function AdminEmployeeCodeDialog({
  employeeId,
  fullName,
  employeeCode,
  onClose,
}: Omit<AdminEmployeeCodeModalProps, "open">) {
  ...
  function submit() {
    ...
    startTransition(async () => {
      try {
        ...
        const message =
          e instanceof Error ? e.message : "Could not save employee code.";
        setError(message);
        toast.error(message);
      }
    });
  ...
  return (
    ...
    >
      ...
      <motion.div
        role="dialog"
        aria-modal="true"
        aria-labelledby="admin-employee-code-title"
